    ...
    public partial class FrmOrderList2 : Form
    {
        ...
        private DataSet getOrderList(String pSDate, String pEDate)
        {
            ...
            try
            {
                ...
                string sql = "";
                sql = sql + " SELECT O.SEQ, O.PSEQ, O.PSSEQ, P.TITLE AS P_TITLE, PO.TITLE AS PO_TITLE, O.STEP, 0.QTY, O.ETC, O.STATUS, O.REQUEST_DATE, O.USER_NAME, C.SEQ AS BIZ_SEQ, C.BIZ_NAME ";
